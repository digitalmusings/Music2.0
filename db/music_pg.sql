...
CREATE INDEX ON "participant_nickname" ("participant_id", "date_start");
...
COMMENT ON COLUMN "link_relation"."relation_type" IS 'submission song seed';
...
COMMENT ON COLUMN "bracket"."size" IS '128 96 64 48 32 0';
...
COMMENT ON COLUMN "notification"."type" IS '"need replacement" "no replacement" "tie"';
